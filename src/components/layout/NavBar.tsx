...
const ICONS: Record<TabKey, ReactNode> = {
  ...
  travel: (
    // An aeroplane, like the header's — the paper plane read as a plain arrow.
    <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
      <path d="M21.5 15.25v-1.9l-7.75-4.6V3.6a1.75 1.75 0 1 0-3.5 0v5.15L2.5 13.35v1.9l7.75-2.35v5.15l-2.25 1.6v1.45L12 20.05l4 .95V19.55l-2.25-1.6V12.9l7.75 2.35Z" />
    </svg>
  ),
};

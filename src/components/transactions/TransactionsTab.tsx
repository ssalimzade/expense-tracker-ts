...
const SOURCES: Source[] = ["monzo", "amex", "chase"];
    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <Select
          ...
          className="min-w-[160px] rounded-xl border border-gray-200 bg-white px-3 py-2 text-sm dark:border-gray-700 dark:bg-gray-800"
        />
        <Select
          value={source}
          onChange={setSource}
          ...
          capitalize
          className="min-w-[140px] rounded-xl border border-gray-200 bg-white px-3 py-2 text-sm dark:border-gray-700 dark:bg-gray-800"
        />
      </div>
      ...
      {showRestorePanel && hiddenRows.length > 0 && (
        <Card className="p-0 overflow-hidden">
          ...
          <ul className="divide-y divide-gray-50 dark:divide-gray-800/60">
            {hiddenRows.map((t) => (
              <li key={t.flag_id} className="flex items-center justify-between px-4 py-2.5">
                <div className="flex items-center gap-3 min-w-0">
                  <span className="text-xs text-gray-400 shrink-0">{t.created?.slice(0, 10)}</span>
                  <span className="truncate text-sm text-gray-700 dark:text-gray-300">{t.description}</span>
                ...
                <button
                  ...
                  className="ml-3 shrink-0 rounded-lg bg-gray-100 px-2.5 py-1 text-xs font-medium text-gray-600 hover:bg-indigo-50 hover:text-indigo-600 dark:bg-gray-700 dark:text-gray-300"
                >
                  Restore
                </button>
              </li>
